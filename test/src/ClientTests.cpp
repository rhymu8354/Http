...
TEST_F(ClientTests, AwaitTransactionNoTimeout) {
    // Set up the client.
    const auto transport = std::make_shared< MockTransport >();
    Http::Client::MobilizationDependencies deps;
    deps.transport = transport;
    ...
    // Wait for client transaction to complete, with no timeout.
...
TEST_F(ClientTests, TransactionCompletionDelegateSetBeforeComplete) {
    // Set up the client.
    const auto transport = std::make_shared< MockTransport >();
    Http::Client::MobilizationDependencies deps;
    deps.transport = transport;
...
TEST_F(ClientTests, TransactionCompletionDelegateSetAfterComplete) {
    // Set up the client.
    const auto transport = std::make_shared< MockTransport >();
    Http::Client::MobilizationDependencies deps;
    deps.transport = transport;
